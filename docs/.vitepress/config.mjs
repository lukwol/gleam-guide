    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Styling", link: "/client/06-styling" },
          {
            text: "Production Deployment",
            link: "/client/07-production-deployment",
          },
          { text: "Recap — The Web App", link: "/client/08-web-app-recap" },
          ...
          { text: "Pull-to-Refresh", link: "/client/13-pull-to-refresh" },
          { text: "Deploy to Device", link: "/client/14-deploy-to-device" },
        ],
      },
    ],
  },
